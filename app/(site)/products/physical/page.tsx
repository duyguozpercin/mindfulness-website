      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h1 className="font-serif text-[clamp(1.8rem,4vw,2.6rem)] text-[#3d3456]">
            Physical Mindfulness Products
          </h1>

          <p className="mx-auto mt-3 max-w-xl leading-7 text-[#9e8aa0]">
            Printed card decks and poster sets designed for daily use in
            classrooms, homes, therapy spaces, and personal practice.
          </p>
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-3 rounded-2xl bg-[#d4ead4] px-5 py-3 text-sm text-[#4a7a5a]">
            <Package size={16} />
            <span>
              <strong>Shipped to your door</strong> — beautifully printed on
              premium materials and ready to use right away.
            </span>
          </div>
        </div>
        ...
        <div className="mt-14 rounded-3xl border border-[#f0e6ee] bg-gradient-to-r from-[#fdf0f5] via-[#f5edfb] to-[#edf4fc] p-8 text-center sm:p-10">
          ...
          <p className="mx-auto mb-6 max-w-md leading-7 text-[#9e8aa0]">
            Explore the full collection of printed mindfulness decks, classroom
            posters, affirmation cards, and family activity sets.
          </p>
